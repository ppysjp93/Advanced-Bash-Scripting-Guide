...
TargetDirectory=~/Project/AdvancedShell/Variables_2/temp
...
# rm -f .[^.]*..?*  to remove filesnames beginning with multiple dots.
# (shopt -s dotglob; rm -f *) will also work
# Thanks, S.C for pointing this out.

#  A filename (`basename`) may contain all character in the 0 - 255 range
#+ except "/".
