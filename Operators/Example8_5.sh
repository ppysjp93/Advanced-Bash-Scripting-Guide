#!/bin/bash
# c-vars.sh
# Manipulating a variable, C-style, using (( ... )) construct.



echo

(( a = 23 ))    #  Setting a vlue, C-style
...
#  In the Bash docs, Ramey (( ... )) shell arithmetic,
#+ but it goes far beyound that.
